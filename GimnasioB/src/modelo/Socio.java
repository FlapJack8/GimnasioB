...
public class Socio extends Rol {
	...
	public Socio(Persona persona,String rol, String estado, Date fechaVen, String tipoAbono, FileInputStream datosMedicos, String estadoAbono, Date fechaVenAbono) {
		super(persona, rol);
		//this.fechaIns = fechaIns;
		this.fechaVen = fechaVen;
		this.tipoAbono = tipoAbono;
