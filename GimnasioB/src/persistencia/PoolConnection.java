...
public class PoolConnection {
	...
	private Connection connect()
	{
		try
		{
			...
			String dbConnectString = "jdbc:sqlserver://25.106.229.240;databaseName=gymb;integratedSecurity=false;sendTimeAsDateTime=false"; //jdbc + servidor; //Esto es para conectarlo en la db de casa 
